  ...
  return (
    <div className="flex flex-col justify-center items-center gap-6">
      <div className="flex flex-col gap-4 w-[320px]">
        {isDarkTheme ? (
          <button 
            className="w-full bg-white dark:bg-[#151515] py-4 px-4 border rounded-lg hover:bg-gray-100 dark:hover:bg-[#202020] flex items-center justify-center gap-6 cursor-pointer"
            type="button"
          >
          ...
          <button 
            className="w-full bg-white dark:bg-[#151515] py-4 px-4 border rounded-lg hover:bg-gray-100  flex items-center justify-center gap-6 cursor-pointer"
            type="button"
          >
